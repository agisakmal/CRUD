...
<div class="register-box">
	...
	<div class="register-box-body">
		...
		<form action="<?php echo base_url() ?>index.php/auth2/reg_action" method="post">
			...
			<div class="form-group has-feedback">
				<input type="password" name="repno_hp" class="form-control" placeholder="repno_hp">
				<span class="glyphicon glyphicon-log-in form-control-feedback"></span>
			</div>
			<div class="row">
				<div class="col-xs-8">
		...
		<a href="<?php echo base_url() ?>index.php/auth2" class="text-center">I already have a membership</a>
	</div>
	<!-- /.form-box -->
</div>
<!-- /.register-box -->
